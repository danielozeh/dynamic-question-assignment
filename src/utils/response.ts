class ResponseHandler {
    ...
    static internalServerError(res: any, message  = `An unknown error occurred while executing request. If this issue persists, please contact a member of support at `, data = []) {
    ...
    static sendSuccess(res: any, {message = "", status_code = 200, data = {}}) {
